...
public class PushNotifications {
    ...
    public static void setUserId(String userId, TokenProvider tokenProvider) {
        setUserId(userId, tokenProvider, new NoopPusherCallback<Void, PusherCallbackError>());
    }
     ...
     */
    public static void setUserId(String userId, TokenProvider tokenProvider, PusherCallback<Void, PusherCallbackError> callback) {
        if (instance == null) {
            throw new IllegalStateException("PushNotifications.start must have been called before");
        }
